...
package cl.ucn.disc.dam.disc_news.activities;
...
import cl.ucn.disc.dam.disc_news.R;
 ...
 */
@Slf4j
public final class MainActivity extends ListActivity implements cl.ucn.disc.dam.disc_news.tasks.GetSaveArticlesTask.TaskListener, ShakeDetector.Listener {

    /**
     * Adapter de {@link cl.ucn.disc.dam.disc_news.model.Article}.
     */
     ...
     */
    private cl.ucn.disc.dam.disc_news.tasks.GetSaveArticlesTask getSaveArticlesTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.articleAdapter = new cl.ucn.disc.dam.disc_news.adapters.ArticleDBFlowAdapter(this);
     ...
     * {@link cl.ucn.disc.dam.disc_news.model.Article} desde Internet.
     */
    private void runGetAndSaveArticlesTask() {
        ...
        this.getSaveArticlesTask = new cl.ucn.disc.dam.disc_news.tasks.GetSaveArticlesTask(this);
        this.getSaveArticlesTask.execute();

    }

    /**
     * Aviso que se termino la obtencion de los {@link cl.ucn.disc.dam.disc_news.model.Article}.
     *
