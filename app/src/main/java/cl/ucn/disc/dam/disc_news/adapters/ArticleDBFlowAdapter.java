package cl.ucn.disc.dam.disc_news.adapters;
...
import cl.ucn.disc.dam.disc_news.model.Article_Table;
...
public final class ArticleDBFlowAdapter extends BaseAdapter {
     ...
     * FlowDB
     */
    private final FlowCursorList<cl.ucn.disc.dam.disc_news.model.Article> flowCursorList;
    ...
    public ArticleDBFlowAdapter(@NonNull final Context context) {
        ...
        this.flowCursorList = new FlowCursorList.Builder<>(
                SQLite.select()
                        .from(cl.ucn.disc.dam.disc_news.model.Article.class)
     ...
     */
    @Override
    public cl.ucn.disc.dam.disc_news.model.Article getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final cl.ucn.disc.dam.disc_news.model.Article article = this.getItem(position);
        if (article != null) {
