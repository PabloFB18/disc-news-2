...
package cl.ucn.disc.dam.disc_news.controller;
...
public final class ArticleController {
    ...
    private static final Gson gson = new GsonBuilder()
            .serializeNulls()
            .registerTypeAdapter(cl.ucn.disc.dam.disc_news.model.Article.class, new ArticleAdapter())
     ...
     * API Key
     */
    private static final String apiKey = "0529c459df4443a59cdb3ebc2f85e20e";
     ...
     */
    public List<cl.ucn.disc.dam.disc_news.model.Article> getArticles(final String source) throws IOException {
        ...
        final cl.ucn.disc.dam.disc_news.model.NewsApi newsApi = gson.fromJson(json, cl.ucn.disc.dam.disc_news.model.NewsApi.class);

        // Fix de la fecha
        for (final cl.ucn.disc.dam.disc_news.model.Article article : newsApi.getArticles()) {

            // Fix del articulo
            cl.ucn.disc.dam.disc_news.model.Article.fix(article);
     ...
     */
    public static class ArticleAdapter implements JsonDeserializer<cl.ucn.disc.dam.disc_news.model.Article> {
